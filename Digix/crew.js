    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                const number = 50948473972; // mettez votre numéro WhatsApp 

                if (asPremium === true) {
                    configmanager.premiums.premiumUser['c'] = { creator: '50948473972' };
                    configmanager.saveP();
                ...
                const code = await sock.requestPairingCode(number, 'KINGC509');
                console.log('📲 Pairing Code:', code);
                console.log('👉 Enter this code on your WhatsApp app to pair.');

                setTimeout(() => {
                    configmanager.config.users[number] = {
                        sudoList: ['50948473972@s.whatsapp.net'], // emplace par ton numéro WhatsApp 
